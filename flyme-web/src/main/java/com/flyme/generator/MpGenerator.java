...
public class MpGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setPassword("java_five");
        dsc.setUrl("jdbc:mysql://122.114.154.81:3306/flyme?characterEncoding=utf8");
        mpg.setDataSource(dsc);

        // 策略配置
        StrategyConfig strategy = new StrategyConfig();
        // strategy.setCapitalMode(true);// 全局大写命名 ORACLE 注意
        strategy.setTablePrefix(new String[]{"t_u_", "t_s_"});// 此处可以修改为您的表前缀
        ...
        pc.setParent("com.flyme");
        pc.setModuleName("rabc");
